...
import { FiSearch, FiUser, FiDollarSign, FiActivity, FiMoreVertical } from 'react-icons/fi';
...
function UserList() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-semibold text-neutral-800 md:hidden">User List</h1>
      ...
      <Card className="bg-white">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex flex-col md:flex-row gap-4 md:items-center">
            ...
            <div className="w-full md:w-auto">
              <label htmlFor="joinDate" className="block text-sm font-medium text-neutral-600 mb-1">
                Join Date
              </label>
              <select
                id="joinDate"
          ...
          <Card title="User Profile">
            {selectedUser ? (
              <div className="space-y-4">
                <div className="flex flex-col items-center p-4">
                  ...
                  <div className="mt-4 w-full flex items-center justify-between">
                    <div className="text-center">
                      <div className="text-2xl font-semibold text-neutral-800">{selectedUser.loanCount}</div>
                ...
                <div className="flex flex-col p-4 bg-neutral-50 rounded-lg border border-neutral-200">
                  <h4 className="text-sm font-medium text-neutral-700 mb-3">Quick Actions</h4>
                  
                  <div className="grid grid-cols-3 gap-2">
                    <button className="btn-secondary py-2 flex flex-col items-center text-sm">
                      <FiActivity size={16} className="mb-1" />
                      <span>Activity</span>
                    </button>
                    <button className="btn-secondary py-2 flex flex-col items-center text-sm">
                      <FiDollarSign size={16} className="mb-1" />
                      <span>Loans</span>
                    </button>
                    <div className="relative">
                      <button 
                        className="btn-secondary py-2 flex flex-col items-center text-sm w-full"
                        onClick={() => setShowUserActions(!showUserActions)}
                      >
                        <FiMoreVertical size={16} className="mb-1" />
                        <span>More</span>
                      </button>
                        ...
                        <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10 border border-neutral-200">
                          <div className="py-1">
                            ...
                            <button 
                              ...
                              disabled={selectedUser.status === 'Flagged'}
                            >
                              Flag Account
                            </button>
                          </div>
                ...
                <div className="p-4 bg-neutral-50 rounded-lg border border-neutral-200">
                  <h4 className="text-sm font-medium text-neutral-700 mb-3">User Notes</h4>
                  <textarea 
                  ...
                  <div className="mt-2 flex justify-end">
                    <button className="btn-primary py-1 px-3 text-sm">Save Note</button>
                  </div>
                </div>
              </div>
            ) : (
              <div className="p-8 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-neutral-500">Select a user to view profile</p>
              </div>
            )}
          </Card>
        </div>
